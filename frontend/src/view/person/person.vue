        ...
        <div class="fl-left avatar-box">
          <div class="user-card">
            ...
            <div class="user-personality">
              ...
              <p class="person-info">This guy is lazy and has nothing left.</p>
            </div>
            <div class="user-information">
              <ul>
                ...
                <el-tooltip
                  class="item"
                  effect="light"
                  content="Technology Department-back-end Business Group"
                  placement="top"
                >
                  <li>
                    <el-icon>
                    ...
                    Technology Department-backend Business Group
                  </li>
                </el-tooltip>
                <li>
                  <el-icon>
        ...
        <div class="user-addcount">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="Account binding" name="second">
              <ul>
                <li>
                  <p class="title">Secure mobile phone</p>
                  <p class="desc">
                    Bound Mobile phone:{{ userStore.userInfo.phone }}
                    <a href="javascript:void(0)" @click="changePhoneFlag = true">Modify immediately</a>
                  </p>
                </li>
                <li>
                  <p class="title">Secure mailbox</p>
                  <p class="desc">
                    Bound mailbox{{ userStore.userInfo.email }}
                    <a href="javascript:void(0)" @click="changeEmailFlag = true">Modify immediately</a>
                  </p>
                </li>
                <li>
                  <p class="title">Secret protection problem</p>
                  <p class="desc">
                    No secret protection problem is set
                    <a href="javascript:void(0)">To set up</a>
                  </p>
                </li>
                <li>
