  ...
  <div>
    ...
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter="onSubmit">
        ...
        <el-form-item label="商户id">
          <el-input v-model.number="searchInfo.merchantId" clearable placeholder="搜索条件" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="商户id" min-width="70" prop="merchantId" />
      ...
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="userForm" :rules="rules" :model="userInfo" label-width="80px">
          ...
          <el-form-item label="商户id" prop="merchantId">
            <el-input v-model.number="userInfo.merchantId" />
          </el-form-item>
...
const getTableData = async() => {
  if (searchInfo.value.merchantId === '') {
    searchInfo.value.merchantId = null
  }
