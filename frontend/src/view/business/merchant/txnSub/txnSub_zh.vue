    ...
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter="onSubmit">
        ...
        <el-form-item label="Bet">
          ...
          <el-input v-model.number="searchInfo.startBet" placeholder="搜索条件（起）" />
          —
          <el-input v-model.number="searchInfo.endBet" placeholder="搜索条件（止）" />
        </el-form-item>
        <el-form-item label="Raise">

          <el-input v-model.number="searchInfo.startRaise" placeholder="搜索条件（起）" />
          —
          <el-input v-model.number="searchInfo.endRaise" placeholder="搜索条件（止）" />
        </el-form-item>
        <el-form-item label="Win">

          <el-input v-model.number="searchInfo.startWin" placeholder="搜索条件（起）" />
          —
          <el-input v-model.number="searchInfo.endWin" placeholder="搜索条件（止）" />
        </el-form-item>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="按钮组">
          <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateTxnSubFunc(scope.row)">变更</el-button>
