...
export const LimitRangesGet = (cluster_id, namespace, name) => {
  return service({
...
export const LimitRangesCreate = (cluster_id, namespace, data) => {
  return service({
...
export const LimitRangesUpdate = (cluster_id, namespace, name,  data) => {
  return service({
    url: `${BaseNamespaceUrl(cluster_id, namespace)}/${name}`,
    method: 'put',
    data
...
export const LimitRangesDelete = (cluster_id, namespace, name) => {
  return service({
    url: `${BaseNamespaceUrl(cluster_id, namespace)}/${name}`,
    method: 'delete',
  })
