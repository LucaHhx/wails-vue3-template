...
<script setup>
import ContainerBase from '@/plugin/kubernetes/components/workloads/container-base.vue'
import ContainerBaseData from '@/plugin/kubernetes/components/workloads/container-base-data.vue'
import Command from '@/plugin/kubernetes/components/workloads/command.vue'
import Ports from '@/plugin/kubernetes/components/workloads/ports.vue'
import Environment from '@/plugin/kubernetes/components/workloads/environment.vue'
import Resources from '@/plugin/kubernetes/components/workloads/resources.vue'
import HealthCheck from '@/plugin/kubernetes/components/workloads/health-check.vue'
import VolumeMount from '@/plugin/kubernetes/components/workloads/volume-mount.vue'
import UpgradeCommonBlock from '@/plugin/kubernetes/components/workloads/spec/upgrade-common.vue'
import UpgradeJobBlock from '@/plugin/kubernetes/components/workloads/spec/upgrade-job.vue'
import AffinityBlock from '@/plugin/kubernetes/components/workloads/spec/affinity.vue'
import TolerationsBlock from '@/plugin/kubernetes/components/workloads/spec/tolerations.vue'
import NetworkingBlock from '@/plugin/kubernetes/components/workloads/spec/networking.vue'
import OthersBlock from '@/plugin/kubernetes/components/workloads/spec/others.vue'
import NodeselectorBlock from '@/plugin/kubernetes/components/workloads/spec/node-selector.vue'
import FormItemBlock from '@/plugin/kubernetes/components/form-item/index.vue'
import FormKVBlock from '@/plugin/kubernetes/components/kv-table/index.vue'
import NamespaceSelectBlock from '@/plugin/kubernetes/components/namespace/index.vue'
import Volume from '@/plugin/kubernetes/components/workloads/volume.vue'
import { reactive, ref } from 'vue'
import { checkName } from '@/plugin/kubernetes/utils/rules'
import { SecretsList } from '@/plugin/kubernetes/api/secrets'
import { ServiceAccountsList } from '@/plugin/kubernetes/api/serviceaccounts'
import { NamespaceList } from '@/plugin/kubernetes/api/namespaces'
import { PersistentVolumeClaimsList } from '@/plugin/kubernetes/api/persistentvolumeclaims'
import { ConfigmapsList } from '@/plugin/kubernetes/api/configmaps'
...
const SecretsWithNs = async(namespace) => {
  const res = await SecretsList(cluster_id.value, '', '', namespace, '', '')
  if (res.code === 0) {
...
const ServiceAccountsWithNs = async(namespace) => {
  const res = await ServiceAccountsList(cluster_id.value, '', '', namespace, '', '')
  if (res.code === 0) {
    res.data.items.forEach((item) => {
...
const loadPvcsWithNs = async(namespace) => {
  const res = await PersistentVolumeClaimsList(cluster_id.value, '', '', namespace, '', '')
  if (res.code === 0) {
...
const loadConfigMapsWithNs = async(namespace) => {
  ...
  const res = await ConfigmapsList(cluster_id.value, '', '', namespace, '', '')
  if (res.code === 0) {
