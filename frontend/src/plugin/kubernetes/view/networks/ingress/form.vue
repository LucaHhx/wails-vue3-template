...
import IngressRule from '@/plugin/kubernetes/components/network/ingress-rule.vue'
import IngressTls from '@/plugin/kubernetes/components/network/ingress-tls.vue'
