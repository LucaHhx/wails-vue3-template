...
import NsSelect from '@/plugin/kubernetes/components/namespace/select-ns.vue'
import ServiceExternalName from '@/plugin/kubernetes/components/network/service-external-name.vue'
import ServicePorts from '@/plugin/kubernetes/components/network/service-ports.vue'
import ServiceSessionAffinity from '@/plugin/kubernetes/components/network/service-session-affinity.vue'
import ServiceIpAddresses from '@/plugin/kubernetes/components/network/service-ip-addresses.vue'
import KVTableBlock from '@/plugin/kubernetes/components/configuration/key-value.vue'
