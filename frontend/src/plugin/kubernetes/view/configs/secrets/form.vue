...
import SecretData from '@/plugin/kubernetes/components/configuration/secret-data.vue'
import SecretDockerData from '@/plugin/kubernetes/components/configuration/secret-docker-data.vue'
import SecretCertificateData from '@/plugin/kubernetes/components/configuration/secret-certificate.vue'
