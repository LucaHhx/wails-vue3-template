...
<script setup>
import { ref } from 'vue'
import MonitorCPU from '@/plugin/kubernetes/components/monitor/pods/cpu.vue'
import MonitorMemory from '@/plugin/kubernetes/components/monitor/pods/memory.vue'
import MonitorNetwork from '@/plugin/kubernetes/components/monitor/pods/network.vue'
import MonitorFilesystem from '@/plugin/kubernetes/components/monitor/pods/filesystem.vue'
import { GetMetrics } from '@/plugin/kubernetes/api/metrics'
import { mapValues } from 'lodash'
import { normalizeMetrics } from '@/plugin/kubernetes/utils/metrics'
