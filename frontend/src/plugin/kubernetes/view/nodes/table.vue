...
import { giMemoryFormat, CpuFormat } from '@/plugin/kubernetes/utils/unitConvert'
const emit = defineEmits(['update', 'delete', 'search', 'detail', 'schedule', 'drain', 'yaml', 'monitor'])
defineProps({
  tableData: {
    default: function() {
      return []
