...
<script setup>
import { ref } from 'vue'
import MonitorCPU from '@/plugin/kubernetes/components/monitor/nodes/cpu.vue'
import MonitorMemory from '@/plugin/kubernetes/components/monitor/nodes/memory.vue'
import MonitorDisk from '@/plugin/kubernetes/components/monitor/nodes/disk.vue'
import MonitorPods from '@/plugin/kubernetes/components/monitor/nodes/pods.vue'
