<template>
  <div>
    <el-table ref="multipleTable" :data="tableData" style="width: 100%" tooltip-effect="dark" row-key="ID">
      ...
      <el-table-column label="匹配Pod数量" min-width="40" prop="status.matchedPods" />
      <el-table-column label="更新Pod数量" min-width="40" prop="status.updatedPods" />
      <el-table-column label="就绪Pod数量" min-width="40" prop="status.readyPods" />
      <el-table-column label="更新就绪Pod数量" min-width="40" prop="status.updatedReadyPods" />
